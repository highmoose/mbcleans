...
export default function SpringCleanBlog() {
    ...
    return (
        <div className="w-full bg-zinc-50 pb-28">
            <Head>
                <title>Spring Cleaning Made Simple | MB Cleans</title>
                <meta
                    name="description"
                    content="Discover our ultimate spring cleaning guide to refresh your home. From essential cleaning supplies to room-by-room tips, make your spring cleaning effort-free."
                />
                <meta
                    property="og:title"
                    content="Spring Cleaning Made Simple | MB Cleans"
                />
                <meta
                ...
                <meta
                    property="og:url"
                    content="https://www.mbcleans.co.uk/blog/spring-clean-article"
                />
                <meta
                    name="twitter:title"
                    content="Spring Cleaning Made Simple | MB Cleans"
                ...
                <link
                    rel="canonical"
                    href="https://www.mbcleans.co.uk/blog/spring-clean-article"
                />
                <script
