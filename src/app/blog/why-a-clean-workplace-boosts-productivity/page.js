...
export default function WorkplaceProductivityBlog() {
    ...
    return (
        <div className="w-full bg-zinc-50 pb-28">
            <Head>
                <title>
                    Why a Clean Workplace Boosts Productivity | MB Cleans
                </title>
                <meta
                    name="description"
                    content="Learn how a clean workplace can enhance productivity, morale, and well-being. Discover the benefits of workplace cleanliness and best practices for maintaining hygiene."
                />
                <meta
                    property="og:title"
                    content="Why a Clean Workplace Boosts Productivity | MB Cleans"
                />
                <meta
                ...
                <meta
                    property="og:url"
                    content="https://www.mbcleans.co.uk/blog/why-a-clean-workplace-boosts-productivity"
                />
                <meta
                    name="twitter:title"
                    content="Why a Clean Workplace Boosts Productivity | MB Cleans"
                ...
                <link
                    rel="canonical"
                    href="https://www.mbcleans.co.uk/blog/why-a-clean-workplace-boosts-productivity"
                />
                <script
