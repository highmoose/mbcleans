  ...
  return (
    <div>
      <div className="text-black bg-slate-50 w-full text-4xl py-16 flex-col mx-auto px-10 lg:px-0">
        ...
        <div className="w-full max-w-6xl px-6 2xl:p-0 mx-auto mb-6">
          <div className="lg:flex gap-x-4">
            <div className="w-full sm:w-1/2 lg:w-1/4 rounded-md group relative inline-block border-gray-100 py-8 font-medium   active:text-white hover:scale-105 hover:shadow-2xl transition duration-100 ease-in-out ">
              ...
              <p className="text-lg text-theme2 text-center font-semibold lg:lg:mb-6">
                Provide us with your details
              </p>
              <p className="text-sm text-center font-light text-gray-400 mb-4 tracking-tight px-16 lg:px-6">
            ...
            <div className="w-full sm:w-1/2 lg:w-1/4 rounded-md group relative inline-block border-gray-100 py-8 font-medium   active:text-white hover:scale-105 hover:shadow-2xl transition duration-100 ease-in-out">
              ...
              <p className="text-lg text-theme2 text-center font-semibold lg:mb-6">
        ...
        <div className="flex items-center">
          <p className="flex mx-auto text-lg leading-5 tracking-tight text-theme2  text-center lg:text-start">
