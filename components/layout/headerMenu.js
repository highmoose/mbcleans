        ...
        return (
            <div className="flex">
                <div className="flex-col justify-center my-auto w-full z-20">
                    ...
                    >
                        <div>
                            <p className="text-[26px]  sm:text-3xl">
                                07710172363
                            </p>
    ...
    return (
        <div className="bg-white">
            ...
            <div className="hidden lg:block ">
                ...
                <div className="absolute z-40 bg-slate-50 left-1/2 -translate-x-1/2 rounded-b-md">
            ...
            <div className="hidden sm:block lg:hidden">
                ...
                <div className="absolute z-40 bg-slate-50 left-1/2 w-2/3 -translate-x-1/2 rounded-b-md">
                    {showServices ? <ServicesDropDown /> : null}
                </div>
            </div>
