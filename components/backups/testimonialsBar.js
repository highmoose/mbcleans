...
export default function TestimonialsBar() {
  return (
    <div class="bg-gray-100 dark:bg-gray-100">
      <div class="w-full">
        <div class="max-w-[85rem] px-4 my-12 sm:px-6 lg:px-8 lg:py-16 mx-auto">
                ...
                <footer class="mt-6">
                  <div class="flex items-center">
                    ...
                    <div class="ms-4 lg:ms-0">
                      ...
                      <p class="text-sm text-gray-600 ">Head of Finance</p>
                    </div>
                  </div>
                </footer>
              </blockquote>
